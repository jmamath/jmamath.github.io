...
>
> **[← Part 2: Architecture](https://jmamathsarr.substack.com/p/architecture-of-synthetic-alignment)** | **[Series Overview](https://jmamathsarr.substack.com/p/synthetic-alignment-research-overview)** | **[Part 4: Research Frontiers →](https://jmamathsarr.substack.com/p/path-forward-research-frontiers)**
>
> In **[Part 1](https://jmamathsarr.substack.com/p/why-rlhf-cant-scale)**, we established RLHF's fundamental limitations. In **[Part 2](https://jmamathsarr.substack.com/p/architecture-of-synthetic-alignment)**, we mapped the design space of the synthetic alignment methods built to overcome them. Now, it's time for the verdict.
>
...
In **[Part 4](https://jmamathsarr.substack.com/p/path-forward-research-frontiers)**, the final article in this series, we will explore these frontiers in depth, examining the five most critical research questions that will shape the future of self-improving AI systems.
