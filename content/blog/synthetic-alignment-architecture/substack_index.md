...
>
> **[← Part 1: RLHF Limitations](https://jmamathsarr.substack.com/p/why-rlhf-cant-scale)** | **[Series Overview](https://jmamathsarr.substack.com/p/synthetic-alignment-research-overview)** | **[Part 3: Evidence →](https://jmamathsarr.substack.com/p/what-works-synthetic-alignment)**
>
> **[Part 1](https://jmamathsarr.substack.com/p/why-rlhf-cant-scale)** established why RLHF faces insurmountable limitations. This article maps the design space of synthetic alignment methods that have emerged in response—revealing which architectural choices matter most and where trade-offs emerge. **[Part 3](https://jmamathsarr.substack.com/p/what-works-synthetic-alignment)** examines the empirical evidence for what actually works. **[Part 4](https://jmamathsarr.substack.com/p/path-forward-research-frontiers)** identifies critical open research questions.
...
![Prompt Generation Strategy](IMAGE_PLACEHOLDER:prompt_strategy.png)
...
![Response Sampling Strategy](IMAGE_PLACEHOLDER:response_sampling.png)
...
![Actor-Judge-Refiner Configuration](IMAGE_PLACEHOLDER:actor_judge_refiner.png)
...
![Response Refinement and Filtering](IMAGE_PLACEHOLDER:response_refinement.png)
...
![Preference Signal Source and Training Implementation](IMAGE_PLACEHOLDER:preference_signal.png)
...
![Nature of the Feedback Signal](IMAGE_PLACEHOLDER:feedback_signal.png)
...
![On-Policy vs Offline Training](IMAGE_PLACEHOLDER:on_policy_vs_offline.png)
