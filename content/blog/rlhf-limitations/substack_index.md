...
>
> **[← Series Overview](https://jmamathsarr.substack.com/p/synthetic-alignment-research-overview)** | [Part 2: Architecture →](https://jmamathsarr.substack.com/p/architecture-of-synthetic-alignment)
> 
> This article examines why Reinforcement Learning from Human Feedback (RLHF), despite powering systems like ChatGPT and Claude, faces fundamental limitations that constrain the development of more capable AI systems. [Part 2](https://jmamathsarr.substack.com/p/architecture-of-synthetic-alignment) explores the synthetic alignment methods emerging in response. [Part 3](https://jmamathsarr.substack.com/p/what-works-synthetic-alignment) assesses which limitations have been solved. [Part 4](https://jmamathsarr.substack.com/p/path-forward-research-frontiers) identifies critical open questions.
...
![Scalability and Resource Constraints of RLHF](IMAGE_PLACEHOLDER:scalability_issues.png)

The economics of human feedback create an insurmountable ceiling for model alignment. As Casper et al. (2023) bluntly state: "The cost of obtaining human feedback is a major bottleneck for RLHF." This isn't merely an inconvenience, it's a fundamental constraint that shapes what's possible in alignment research. Our companion article, **[The Economics of Alignment: Why RLAIF Delivers 11x Cost Reduction](https://jmamathsarr.substack.com/p/economics-of-alignment-rlaif)**, provides a detailed quantitative case study demonstrating this disparity.
...
![Reward Model Limitations](IMAGE_PLACEHOLDER:reward_model_limitations.png)
...
![Human Feedback Quality and Governance Limitations](IMAGE_PLACEHOLDER:human_feedback_and_governance_challenges.png)
...
The shift from human feedback to synthetic alignment isn't a rejection of RLHF's insights—it's an evolution that preserves what works while systematically addressing what doesn't. **[Part 2](https://jmamathsarr.substack.com/p/architecture-of-synthetic-alignment)** of this series provides a systematic framework for understanding these synthetic alignment methods by mapping the design space itself—revealing which architectural choices matter most, where trade-offs emerge, and what the empirical evidence tells us about effective strategies.
...
**Continue to [Part 2: The Architecture of Synthetic Alignment](https://jmamathsarr.substack.com/p/architecture-of-synthetic-alignment)** to explore how modern methods address these limitations through carefully designed pipelines and training strategies.
