...
>
> **[← Series Overview](https://jmamathsarr.substack.com/p/synthetic-alignment-research-overview)** | **[Part 1: RLHF Limitations →](https://jmamathsarr.substack.com/p/why-rlhf-cant-scale)**
>
> This article provides a concrete cost analysis demonstrating why the scalability limitations discussed in [Part 1](https://jmamathsarr.substack.com/p/why-rlhf-cant-scale) aren't merely theoretical concerns—they translate to order-of-magnitude differences in real-world economics. We compare two approaches from Meta AI research: Llama 2's human preference collection and Self-Rewarding Language Models' synthetic preference generation.
...
Cost reduction is meaningless if synthetic preferences don't work. The evidence from [Part 3](https://jmamathsarr.substack.com/p/what-works-synthetic-alignment) suggests they do work, often matching or exceeding human feedback performance, but this remains an area of active research.
...
The next frontier isn't whether to use synthetic methods—it's how to use them effectively, which judge models to deploy, and how to audit and mitigate their systematic biases. These are the questions explored in [Part 2](https://jmamathsarr.substack.com/p/architecture-of-synthetic-alignment), [Part 3](https://jmamathsarr.substack.com/p/what-works-synthetic-alignment), and [Part 4](https://jmamathsarr.substack.com/p/path-forward-research-frontiers) of this series.
